...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DGCollectionViewPaginableBehavior/DGCollectionViewPaginableBehavior.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NTDownload/NTDownload.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SubtleVolume/SubtleVolume.framework"
